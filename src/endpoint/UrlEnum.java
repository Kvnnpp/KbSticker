...
public enum UrlEnum {
    ...
    //API DA NASA
    API_NASA("https://api.nasa.gov/planetary/apod?api_key=lQG2KP7vF6vP23bmvAgDbaiB615QOy5UkRPyhswy&start_date="+DataAtual.getSeteDiasAntes()+"&end_date="+DataAtual.getHoje()),
